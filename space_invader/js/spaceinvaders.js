...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Space Invaders by Somnath ACHARYA", game.width / 2, game.height/2 - 40); 
    ctx.font="16px Arial";
...
GameOverState.prototype.keyDown = function(game, keyCode) {
    ...
    if(keyCode == KEY_ESC){
        console.log("here")
        var level = localStorage.getItem('space_invader_level')
        var score = localStorage.getItem('space_invader_score')
        $.ajax({
            type: "POST",
            data: {score:score,level:level},
            url: '/space_invader/score',
            dataType: "json",
